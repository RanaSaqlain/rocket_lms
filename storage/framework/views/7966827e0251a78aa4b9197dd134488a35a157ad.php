                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-large-icons">
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?php echo e(getAdminPanelUrl("/settings/update-app")); ?>" class="card-cta text-primary">Install License<i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/sites/LMS/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>